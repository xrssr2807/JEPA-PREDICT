...
class DataConfig:
    ...
    multidisease_split_file: str = "splits/multidisease_taskaware_downstream.json"
...
class ModelConfig:
    ...
    # Optional PPG-only raw morphology residual for wearable deployment.
    downstream_ppg_morphology_head: bool = False
